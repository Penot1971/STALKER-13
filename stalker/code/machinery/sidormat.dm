...
GLOBAL_LIST_INIT(global_sidormat_list, list(
	...
	"Masks and Helmets" = list(
		...
		new /datum/data/stalker_equipment("Renegade Ballistic Mask",    "Renegade Ballistic Mask",      /obj/item/clothing/mask/gas/stalker/renegademask,               12500,  EXPERIENCED,    faction = "Renegades")
	),
